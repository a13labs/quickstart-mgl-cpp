...
namespace AppCore
{
  ...
  Application::Application(const ApplicationConfig& config)
  {
    ...
    APPCORE_INFO("Application: Creating window {0},{1} with OpenGL support",
                 mData.Config.Width,
                 mData.Config.Height);
    mWindow = SDL_CreateWindow(mData.Config.Title.c_str(),
  ...
  void Application::OnEvent(Events::Event& event)
  {
    ...
    dispatcher.Dispatch<Events::WindowCloseEvent>(
        APPCORE_BIND_EVENT_FN(Application::OnWindowClose));
    dispatcher.Dispatch<Events::WindowResizeEvent>(
        APPCORE_BIND_EVENT_FN(Application::OnWindowResize));
    ...
    dispatcher.Dispatch<Events::KeyReleasedEvent>(
        APPCORE_BIND_EVENT_FN(Application::OnKeyReleased));
    ...
    dispatcher.Dispatch<Events::MouseScrolledEvent>(
        APPCORE_BIND_EVENT_FN(Application::OnMouseScrolled));
    dispatcher.Dispatch<Events::MouseButtonPressedEvent>(
        APPCORE_BIND_EVENT_FN(Application::OnMouseButtonPressed));
    dispatcher.Dispatch<Events::MouseButtonReleasedEvent>(
        APPCORE_BIND_EVENT_FN(Application::OnMouseButtonReleased));
  }
