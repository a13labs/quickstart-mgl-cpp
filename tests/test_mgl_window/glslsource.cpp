...
*/
#include "mgl_window/resources/glslsource.hpp"
...
#line 4
  ...
  auto vs_source = shader.source(mgl_window::resources::ShaderSource::type::VERTEX_SHADER, { { "A", "1" }, { "B", "2" } });
  auto fs_source = shader.source(mgl_window::resources::ShaderSource::type::FRAGMENT_SHADER, { { "A", "1" }, { "B", "2" } });
